...
import com.nik.weathernik.api.getWeatherIconRes
...
fun WeatherDetails(data : WeatherModel) {
    Column(
        ...
        Image(
            painter = painterResource(id = getWeatherIconRes(conditionCode, isDay)),
        ...
        Card {
            Column(
                ...
                Row(
                    ...
                    WeatherKeyVal("Direction",data.current.wind_dir)
